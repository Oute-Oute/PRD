...
function getMessageWorkingHours(scheduledActivity, humanResourceId) {
  ...
  humanResources.forEach((resource) => { //browse all human resources
    if (resource.id == humanResourceId) {
      ...
      console.log(workingHoursStart.getTimezoneOffset())
      if (workingHoursStart.getTimezoneOffset() == -120) {
        workingHoursStart = new Date(workingHoursStart.getTime() + 2 * 60 * 60 * 1000);
        workingHoursEnd = new Date(workingHoursEnd.getTime() + 2 * 60 * 60 * 1000);
        activityStart = new Date(scheduledActivity.start.getTime() + 2 * 60 * 60 * 1000);
        activityEnd = new Date(scheduledActivity.end.getTime() + 2 * 60 * 60 * 1000);
      }
      else {
        workingHoursStart = new Date(workingHoursStart.getTime() + 60 * 60 * 1000);
        workingHoursEnd = new Date(workingHoursEnd.getTime() + 60 * 60 * 1000);
        activityStart = new Date(scheduledActivity.start.getTime() + 60 * 60 * 1000);
        activityEnd = new Date(scheduledActivity.end.getTime() + 60 * 60 * 1000);
      }
      ...
      if (!(workingHoursStart <= activityStart &&
        activityEnd <= workingHoursEnd)) {
        //set an error message
