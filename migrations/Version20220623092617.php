 ...
 */
final class Version20220623092617 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__activity_resource_type AS SELECT id FROM activity_resource_type');
        $this->addSql('DROP TABLE activity_resource_type');
        $this->addSql('CREATE TABLE activity_resource_type (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)');
        $this->addSql('INSERT INTO activity_resource_type (id) SELECT id FROM __temp__activity_resource_type');
