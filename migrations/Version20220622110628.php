 ...
 */
final class Version20220622110628 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_1325F3A6F891DA76');
        $this->addSql('CREATE TEMPORARY TABLE __temp__circuit AS SELECT id, name FROM circuit');
        ...
        $this->addSql('INSERT INTO circuit (id, name) SELECT id, name FROM __temp__circuit');
        $this->addSql('DROP TABLE __temp__circuit');
        $this->addSql('DROP INDEX UNIQ_F8CB7C606146A8E4');
        $this->addSql('DROP INDEX UNIQ_F8CB7C60BC21E890');
        $this->addSql('CREATE TEMPORARY TABLE __temp__circuit_event AS SELECT id, circuit_id_id, activity_id_id FROM circuit_event');
        $this->addSql('DROP TABLE circuit_event');
        $this->addSql('CREATE TABLE circuit_event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, circuit_id_id INTEGER DEFAULT NULL, activity_id_id INTEGER DEFAULT NULL, CONSTRAINT FK_F8CB7C60BC21E890 FOREIGN KEY (circuit_id_id) REFERENCES circuit (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_F8CB7C606146A8E4 FOREIGN KEY (activity_id_id) REFERENCES activity (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO circuit_event (id, circuit_id_id, activity_id_id) SELECT id, circuit_id_id, activity_id_id FROM __temp__circuit_event');
        $this->addSql('DROP TABLE __temp__circuit_event');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE circuit_type (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('DROP INDEX IDX_1377854681C06096');
        $this->addSql('DROP INDEX IDX_13778546CF2182C8');
        $this->addSql('CREATE TEMPORARY TABLE __temp__activity_circuit AS SELECT activity_id, circuit_id FROM activity_circuit');
        $this->addSql('DROP TABLE activity_circuit');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__circuit AS SELECT id, name FROM circuit');
        $this->addSql('DROP TABLE circuit');
        $this->addSql('CREATE TABLE circuit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, circuit_type_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO circuit (id, name) SELECT id, name FROM __temp__circuit');
        $this->addSql('DROP TABLE __temp__circuit');
