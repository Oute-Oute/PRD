 ...
 */
class getActivityResourceTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ActivityResourceTypeRepository' shared autowired service.
     *
     * @return \App\Repository\ActivityResourceTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ActivityResourceTypeRepository.php';

        return $container->privates['App\\Repository\\ActivityResourceTypeRepository'] = new \App\Repository\ActivityResourceTypeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
