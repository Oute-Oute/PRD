 ...
 */
class getCompleteActivityRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompleteActivityRepository' shared autowired service.
     *
     * @return \App\Repository\CompleteActivityRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompleteActivityRepository.php';

        return $container->privates['App\\Repository\\CompleteActivityRepository'] = new \App\Repository\CompleteActivityRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
