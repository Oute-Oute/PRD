 ...
 */
class getCircuitPatientRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CircuitPatientRepository' shared autowired service.
     *
     * @return \App\Repository\CircuitPatientRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CircuitPatientRepository.php';

        return $container->privates['App\\Repository\\CircuitPatientRepository'] = new \App\Repository\CircuitPatientRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
