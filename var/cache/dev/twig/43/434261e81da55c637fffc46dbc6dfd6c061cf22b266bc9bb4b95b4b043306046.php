...
class __TwigTemplate_fcd23eedfa7d2e5c3a2c423ca8238ffdb1151afcc7baabef884937706ef11299 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        echo "
    <button type = \"submit\" class=\"btn_valide_user btn-secondary\">";
        // line 3
...
";
    ...
    {{ form_widget(form) }}
    <button type = \"submit\" class=\"btn_valide_user btn-secondary\">{{ button_label|default('Valider') }}</button>
{{ form_end(form) }}
