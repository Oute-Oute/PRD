 ...
 */
class getCompleteActivityResourceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompleteActivityResourceRepository' shared autowired service.
     *
     * @return \App\Repository\CompleteActivityResourceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompleteActivityResourceRepository.php';

        return $container->privates['App\\Repository\\CompleteActivityResourceRepository'] = new \App\Repository\CompleteActivityResourceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
