 ...
 */
class getResourceTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ResourceTypeRepository' shared autowired service.
     *
     * @return \App\Repository\ResourceTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ResourceTypeRepository.php';

        return $container->privates['App\\Repository\\ResourceTypeRepository'] = new \App\Repository\ResourceTypeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
