 ...
 */
class getActivityCircuitRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ActivityCircuitRepository' shared autowired service.
     *
     * @return \App\Repository\ActivityCircuitRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ActivityCircuitRepository.php';

        return $container->privates['App\\Repository\\ActivityCircuitRepository'] = new \App\Repository\ActivityCircuitRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
