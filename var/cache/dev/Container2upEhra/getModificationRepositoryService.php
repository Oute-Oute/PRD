 ...
 */
class getModificationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ModificationRepository' shared autowired service.
     *
     * @return \App\Repository\ModificationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ModificationRepository.php';

        return $container->privates['App\\Repository\\ModificationRepository'] = new \App\Repository\ModificationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
