 ...
 */
class getResourceRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ResourceRepository.php';

        return $container->privates['App\\Repository\\ResourceRepository'] = new \App\Repository\ResourceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
